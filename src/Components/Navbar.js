...
export default function NavBar(){
  ...
  <div className="col-md-12 flow"> 
    <a align="left" className="col-md-2" href="../welcome"><h2 className="main">The Gathering</h2></a>
    ...
    <a  align="center" className="col-md-2 col-md" href="../contact"><h1 className="link">Contact</h1></a>
</div>
</nav>
)
}